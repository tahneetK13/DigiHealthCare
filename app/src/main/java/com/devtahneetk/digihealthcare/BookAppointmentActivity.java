...
public class BookAppointmentActivity extends AppCompatActivity {
    ...
    btnBook.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (db.checkAppointmentExists(username,title+"=>"+fullname,address,contact,timeButton.getText().toString(),dateButton.getText().toString())==1){
                Toast.makeText(getApplicationContext()," Appontment already booked",Toast.LENGTH_SHORT).show();
            }else{
                ...
                startActivity(new Intent(BookAppointmentActivity.this,BuyMedicineActivity.class));
            }
        }
    });

//username,title+"=>"+fullname,address,contact,0,dateButton.getText().toString(),timeButton.getText().toString()
}
